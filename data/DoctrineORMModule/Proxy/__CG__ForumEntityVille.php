 ...
 */
class Ville extends \Forum\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Forum\\Entity\\Ville' . "\0" . 'codePostal', '' . "\0" . 'Forum\\Entity\\Ville' . "\0" . 'nomVille'];
        }
    ...
    public function getCodePostal()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCodePostal();
        }
